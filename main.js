...
var mapOptions = {zoom: 14, center: HUMAN_POSITION };
var pervomayskaya = {lat: 53.893818, lng:27.570962};
var nemiga = {lat: 53.905947, lng: 27.554066};
var frunzenscaya = {lat: 53.905225, lng: 27.539205};
var lenina = {lat: 53.892892, lng: 27.547887};
var oktyaborskaya = {lat: 53.902131, lng: 27.562246};
var pobedi = {lat: 53.909543, lng: 27.576308};

var select = document.getElementById('station-selector');
var route = document.getElementById('show-route');
...
function initMap() {
    ...
    var human = new google.maps.Marker({
    ...
    var pervomayskaya_marker = new google.maps.Marker({
    ...
    var nemiga_marker = new google.maps.Marker({
        position: nemiga,
        animation: google.maps.Animation.DROP,
        map: map,
        title: 'Немига',
    ...
    var frunzenscaya_marker = new google.maps.Marker({
        position: frunzenscaya,
        animation: google.maps.Animation.DROP,
        map: map,
        title: 'Фрунзенская',
    });  
    var lenina_marker = new google.maps.Marker({
        position: lenina,
        animation: google.maps.Animation.DROP,
        map: map,
        title: 'Площадь Ленина',
    });
    var oktyaborskaya_marker = new google.maps.Marker({
        position: oktyaborskaya,
        animation: google.maps.Animation.DROP,
        map: map,
        title: 'Октяборьская',
    });    
    var pobedi_marker = new google.maps.Marker({
        position: pobedi,
        animation: google.maps.Animation.DROP,
        map: map,
        title: 'Площадь победы',
    });  
    var markers = [pervomayskaya_marker,nemiga_marker,frunzenscaya_marker,
